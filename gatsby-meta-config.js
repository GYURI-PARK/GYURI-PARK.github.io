module.exports = {
  ...
  comments: {
    utterances: {
      repo: `GYURI-PARK/blog-comment`, // `zoomkoding/zoomkoding-gatsby-blog`,
    },
  },
  ...
  author: {
    ...
    bio: {
      ...
      thumbnail: 'real-move-mimoticon.gif', // Path to the image in the 'asset' folder
    },
    social: {
  ...
  about: {
    timestamps: [
      ...
      },
      {
        ...
        activity: '서울시립대학교 공간정보공학과 & 빅데이터분석학 학위 취득',
      },
      {
